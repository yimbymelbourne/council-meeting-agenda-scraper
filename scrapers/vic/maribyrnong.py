...
class MaribyrnongScraper(BaseScraper):
    ...
    def scraper(self) -> ScraperReturn | None:
        ...
        name_date_details = soup.find("ul", class_='content-details-list minutes-details-list')
        ...
        if agenda_div:
            meeting_name = agenda_div.find('h2')  # This may need adjustment if the structure is different
            if meeting_name:
                ...
                if docName == "Agenda":
                    ...
                    if agenda_link and 'href' in agenda_link.attrs:
                        ...
                        if not download_url.startswith('http'):
                            download_url = 'https://www.maribyrnong.vic.gov.au' + download_url
                else:
